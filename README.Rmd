...
More details on the different rounding specification rules are given in the package vignette: "Rounding specifications" (not written yet; in progress). One final nice feature of `table.glue` is the ability to make any rounding specification the default rounding specification used by all of the `table_` functions, including `table_glue`:
